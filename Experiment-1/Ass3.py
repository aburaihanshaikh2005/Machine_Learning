'''Write a script to add a new dynamically calculated column named Grade to the DataFrame
based on the Marks column.'''
import pandas as pd
data={
    "Student_Name":["Raihan","Yammen","Obaid","Raj","Rahul"],
